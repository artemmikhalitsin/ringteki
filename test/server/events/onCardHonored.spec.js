...
fdescribe('Savvy Politician', function() {
    integration(function() {
        ...
        describe('when the politician is already honored', function() {
            ...
            it('should not trigger its ability when winning a conflict with kimono attached', function() {
                this.player1.attach(this.kimono, this.politician);
                this.noMoreActions();
            ...
            fit('should not trigger its ability when breaking The Art of War', function() {
                this.noMoreActions();
                this.initiateConflict({
                ...
                expect(this.player2.currentActionTargets).not.toInclude(this.politician2);
            });
        });
    });
});
